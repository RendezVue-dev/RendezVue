...
- [x] In `readme.md`, check off the features you have completed in this unit by adding a ✅ emoji in front of the feature's name. (pending)
...
We successfully learned how to use GitHub Projects to organize our workflow and keep everything systematic. It helped our team clearly track progress, assign tasks, and maintain better collaboration.

### 2. What were some challenges your group faced in this unit?

One of our main challenges was dividing responsibilities effectively and creating well-documented issue reports on GitHub. We’re still improving our communication and coordination to make sure each task is clearly defined and assigned.
...
We haven’t finished all of our tasks yet, we’re still working on the database implementation. Our next step is to prioritize completing the database setup since it’s a core component that other features depend on.

### 4. Which features and user stories would you consider “at risk”? How will you change your plan if those items remain “at risk”?

The location-based matching feature is currently “at risk” because of the robustness of this idea. 
